...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" JOE GANTENG  [MrXsvs]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Turub Kastrol"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3RC1L] [MR.S∆MAx] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AldykaPrygh]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 083821597037"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" azisbaeatuh@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB MrXsvs    "$i"|"$i"    |"$cy" E"$i" |"
...
sleep 1
git clone https://github.com/MrXsvs/fbbrute
cd fbbrute
php fb.php
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/MrXsvs/Fb-Cracker-v.3
cd Fb-Cracker-v.3
python2 crack.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/MrXsvs/mbf
cd mbf
python2 MBF.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/MrXsvs/EmailVuln
cd EmailVuln
python2 vuln.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/MrXsvs/ProfileGuardFb
cd ProfileGuardFb
php guard.php
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/MrXsvs/InfoFB
cd InfoFB
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/MrXsvs/autolike
cd autolike
php autolike.php
fi
...
sleep 2
echo $ku"WhatsApp :"$i" 083821597037"
echo $ku"Facebook :"$i" Turub Kastrol"
sleep 2
